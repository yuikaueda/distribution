...
data0 = np.loadtxt('f0_nu0.2_kkb4e-0_f0_1e-12_l080.dat')
data1 = np.loadtxt('f0_nu0.2_kkb4e-0_f0_1e-0_l080.dat')
...
axe.legend()
plt.show()
fig.savefig("2data_y200kkb4e-0_f01e-12ande-0_l080.png")
